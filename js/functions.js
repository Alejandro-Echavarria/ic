document.addEventListener("DOMContentLoaded", function (event) {
  ...
  form.onsubmit = function (e) {
    ...
    let cadena = identificarCadena.value;
		...
		/* Obtenemos las posisciones de los primeros parentesis */
		...
		if (indice1 === -1 || indice2 === -1) {
				return toast("No existen los parentesís necesarios", "toast-error");
		}

    for (let i = 1; i; i++) {

			indice1 = cadena.indexOf("(");
			indice2 = cadena.indexOf(")") + 1; // Sumamos un valor para poder extraer los elementos con su parentesís de cierre

			if (indice2 != 0) {

				// Obtenemos los elementos de cada pareja de parentesís
